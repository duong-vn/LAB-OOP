...
public class CartTest {
	 public static void main(String[] args) {
	        ...
	        DigitalVideoDisc dvd01 = new DigitalVideoDisc("The Lion King",
	                "Animation", "Roger Allers", 87, 19.95f);
	        cart.addMedia(dvd01);

	        DigitalVideoDisc dvd02 = new DigitalVideoDisc("Star Was",
	                "Science Fiction", "George Lucas", 87, 24.95f);
	        cart.addMedia(dvd02);

	        DigitalVideoDisc dvd03 = new DigitalVideoDisc("Aladin",
	                "Animation", 18.99f);
	        cart.addMedia(dvd03);
	        ...
	        DigitalVideoDisc dvd1 = new DigitalVideoDisc("The Lion King", "Animation", "Roger Allers, Rob Minkoff", 88, 19.99f);
	        ...
	        CompactDisc cd1 = new CompactDisc("Abbey Road", "Rock", 10.99f, 47, "The Beatles", "The Beatles");
