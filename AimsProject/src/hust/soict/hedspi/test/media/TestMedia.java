...
public class TestMedia {
	 ...
	 public static void main(String[] args) {
	        ...
	        DigitalVideoDisc dvd = new DigitalVideoDisc("The Lion King", "Animation", "Roger Allers, Rob Minkoff", 88, 24.99f);
	        CompactDisc cd = new CompactDisc("Abbey Road", "Rock", 10.99f, 47, "The Beatles", "The Beatles");
